...
def readDetails(contract_type):
    ...
    deployed_contract_address =  '0x3564Ed78378ca57E893b99bDAdE2C275d58C80d8'#'0xE84CDbBC6049E54CCA2659B76f0318EC6d68e847'#'0xE833CF5566e5c4e4E8cA960afc5c978469303fC4' #hash address to access counter feit contract
...
def saveDataBlockChain(currentData, contract_type):
    ...
    deployed_contract_address = '0x3564Ed78378ca57E893b99bDAdE2C275d58C80d8'#'0xE84CDbBC6049E54CCA2659B76f0318EC6d68e847'#'0xE833CF5566e5c4e4E8cA960afc5c978469303fC4' #contract address
    with open(compiled_contract_path) as file:
        contract_json = json.load(file)  # load contract info as JSON
        contract_abi = contract_json['abi']  # fetch contract's abi - necessary to call its functions
    file.close()
